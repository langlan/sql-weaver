 ...
 */
public abstract class SqlD<T extends SqlD<T>> extends InlineStrategySupport<T> implements CriteriaStrategyAware,
	VariablesBound {
	...
	/**
	 * Append costum item-fragment to the previous cluase of the sql.<br/>
